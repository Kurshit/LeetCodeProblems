...
/*
 * SOLUTION 5 : Using CountDownLatch
 */
...
public class PrintInOrderUsingCountDownLatch {
	...
	private static class CallsFirst implements Runnable {
		private FooCountDownLatch foo;
		private PrintsFirst first;

		public CallsFirst(FooCountDownLatch foo, PrintsFirst first) {
			this.foo = foo;
			this.first = first;
		}
	...
	private static class CallsSecond implements Runnable {
		...
		public CallsSecond(FooCountDownLatch foo, PrintsSecond seconds) {
			this.foo = foo;
	...
	private static class CallsThird implements Runnable {
		...
		public CallsThird(FooCountDownLatch foo, PrintsThird thirds) {
			this.foo = foo;
			this.thirds = thirds;
		}
