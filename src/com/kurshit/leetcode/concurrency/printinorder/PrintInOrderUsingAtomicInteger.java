...
public class PrintInOrderUsingAtomicInteger {

	public static void main(String[] args) {

		FooAtomic foo = new FooAtomic();
	...
	private static class CallsFirst implements Runnable {
		private FooAtomic foo;
		private PrintsFirst first;

		public CallsFirst(FooAtomic foo, PrintsFirst first) {
			this.foo = foo;
			this.first = first;
		}
	...
	private static class CallsSecond implements Runnable {
		...
		public CallsSecond(FooAtomic foo, PrintsSecond seconds) {
			this.foo = foo;
	...
	private static class CallsThird implements Runnable {
		...
		public CallsThird(FooAtomic foo, PrintsThird thirds) {
			this.foo = foo;
			this.thirds = thirds;
		}
